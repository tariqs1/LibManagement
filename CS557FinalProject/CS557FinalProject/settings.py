"""
Django settings for CS557FinalProject project.
...
SECRET_KEY = 'django-insecure-5kz&-r@u9l=^3f_pmc#i%+%ola2cmzve&&%z(36cqdc_cg*80t'
...
ROOT_URLCONF = 'CS557FinalProject.urls'
